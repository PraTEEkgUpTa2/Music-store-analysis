...
The following are a few of the questions that are answered in the project (check out <a href="[https://github.com/avishek09/Music-Store-Analysis/blob/main/analysis.sql](https://github.com/PraTEEkgUpTa2/Music-store-analysis/blob/main/Music%20store%20analysis/Music-Store-Analysis/analysis.sql)">analysis.sql</a> file for the rest):
